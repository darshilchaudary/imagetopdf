...
import example.createpdf.activity.CropImageActivity;
import example.createpdf.adapter.EnhancementOptionsAdapter;
import example.createpdf.database.DatabaseHelper;
import example.createpdf.interfaces.OnItemClickListner;
import example.createpdf.interfaces.OnPDFCreatedInterface;
import example.createpdf.model.EnhancementOptionsEntity;
import example.createpdf.model.ImageToPDFOptions;
import example.createpdf.util.Constants;
import example.createpdf.util.CreatePdf;
import example.createpdf.util.FileUtils;
import example.createpdf.util.MorphButtonUtility;
import example.createpdf.util.PageSizeUtils;
import example.createpdf.util.StringUtils;

import static example.createpdf.util.Constants.AUTHORITY_APP;
import static example.createpdf.util.Constants.DEFAULT_BORDER_WIDTH;
import static example.createpdf.util.Constants.DEFAULT_COMPRESSION;
import static example.createpdf.util.Constants.DEFAULT_IMAGE_BORDER_TEXT;
import static example.createpdf.util.Constants.DEFAULT_IMAGE_SCALETYPE_TEXT;
...
import static example.createpdf.util.Constants.DEFAULT_QUALITY_VALUE;
import static example.createpdf.util.Constants.IMAGE_SCALE_TYPE_ASPECT_RATIO;
...
import static example.createpdf.util.Constants.RESULT;
...
import static example.createpdf.util.DialogUtils.createCustomDialog;
...
import static example.createpdf.util.ImageEnhancementOptionsUtils.getEnhancementOptions;
import static example.createpdf.util.ImageUtils.mImageScaleType;
import static example.createpdf.util.ImageUtils.showImageScaleTypeDialog;
